                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('pob') ? ' has-error' : '' }}">
                            <label for="pob" class="col-md-4 control-label">Tempat Lahir</label>
                        ...
                        <div class="form-group{{ $errors->has('pol') ? ' has-error' : '' }}">
                            <label for="pol" class="col-md-4 control-label">Kota Tinggal</label>

                            <div class="col-md-6">
                                <input id="pol" type="text" class="form-control" name="pol" value="{{ old('pol') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('jk') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="radio" class="radio-inline" name="jk" value="Laki-laki" > Laki-laki
